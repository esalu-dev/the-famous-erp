...
export default function InsumosPage() {
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 text-xs mt-2">Gestión de inventario y costos de insumo críticos para producción</p>
      <div className="mt-6">
            <CategoryTags categories={categories} />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mt-6">
        <InsumoCard titulo="Pepperoni importado" categoria="A" precio={12.50} stock={45.0} unidad="kg"/>
      ...
      <span>
        <Button isIconOnly size="lg" className="fixed right-6 bottom-6" onPress={() => setIsModalOpen(true)}>
          <Plus />
        </Button>
      </span>
