    ...
    <Card className="w-full h-[400px] overflow-hidden">
      ...
      <div className="flex flex-1 flex-col gap-3">
        <Card.Header className="gap-3">
            ...
            <Chip size="md" color={categoria ? categoryStyles[categoria].color : categoryStyles.A.color} variant={categoria ? categoryStyles[categoria].variant : categoryStyles.A.variant} className="rounded-full font-bold w-fit">
              Categoría {categoria}
            </Chip>
        </Card.Header>
